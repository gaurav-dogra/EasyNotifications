...
namespace EasyNotificationsApp.Controllers
{
    public class UsersController : Controller
    {
        private readonly EasyNotificationsAppContext _context;

        public UsersController(EasyNotificationsAppContext context)
        {
            _context = context;
        }
